...
- 投資組合:\
  ...
  - 空頭:<font color = "red">賣</font>出情緒分數最**低**的5篇新聞對應之股票\
- 買賣方式:\
  - 等權重(Equal-Weight, EW)\
...
| 策略   | 對應時間範圍                  | 說明                                       |
|--------|-------------------------------|--------------------------------------------|
| Day−1  | 第 T−1 天開盤 → 第 T 天開盤   | 新聞尚未發佈，股價已有劇烈反應，可能反映內線消息 | 
| Day0   | 第 T 天開盤 → 第 T+1 天開盤     | 新聞當天即時反應，但無法事先進場            |
| Day+1  | 第 T+1 天開盤 → 第 T+2 天開盤 | 新聞隔天仍有顯著反應，情緒延遲反應仍可帶來超額報酬，是可行的交易策略     |
...
- 郭亭佑. (2021). 透過文字探勘預測台股報酬. 政治大學金融學系學位論文\
- Blei, D. M., Ng, A.Y., andJordan, M.I.(2003). Latent dirichlet allocation. Journal of Machine Learning Research, 3,993-1022\
...
- Jegadeesh, N., and Wu, D. (2013). Word power: A new approach for content anal
ysis. Journal of Financial Economics, 110(3), 712-729.\

---

##

- Ke, Z. T., Kelly, B. T., and Xiu, D. (2019). Predicting returns with text data. Work
ing Paper.\
...
- Manela, A., and Moreira, A. (2017). News implied volatility and disaster concerns. Journal of Fi- nancial Economics, 123(1), 137–162.\
...
- You, J., Zhang, B., and Zhang, L. (2018). Who captures the power of the pen?.
 Review of Financial Studies, 31(1), 43–96\
